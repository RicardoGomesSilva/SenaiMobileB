...
public class MainActivity extends AppCompatActivity {
    ...
    public void salvarFoto() {
        ...
        Log.d(TAG, "... ENTROU NO SALVAR FOTO ...");

     try{

         Log.d(TAG, "... TRY SALVAR FOTO ...");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            if (requestCode == 123 && resultCode == Activity.RESULT_OK) {
                ...
                Log.d(TAG, "... CHAMOU VER_FOTO_TIRADA() ...");
                verFotoTirada();
                Log.d(TAG, "... SAIU VER_FOTO_TIRADA() ...");

                Log.d(TAG, "... CHAMOU_SALVAR_FOTO() ...");
                salvarFoto();
                Log.d(TAG, "... SAIU SALVAR_FOTO() ...");
